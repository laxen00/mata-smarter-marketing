...
(function (factory) {
  ...
  var editable = renderer.create('<div id="btn-input1" class="note-editable panel-body" contentEditable="true" oninput="checkInput()"/>');
  ...
  var airEditable = renderer.create('<div id="btn-input1" class="note-editable" contentEditable="true" oninput="checkInput()"/>');
  ...
  var dialog = renderer.create('<div id="linkModal" class="modal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    if (options.fade) {
      $node.addClass('fade');
    }
    $node.html([
      ...
      '      <button id="closeModal" type="button" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
      ...
      '  </div>',     
      '</div>',
      '<script>$("#closeModal").click(function(){$("#linkModal").modal("hide");});</script>'   
    ].join(''));
  });
